...
import java.util.Scanner;
    ...
    class RedBlackNode
    {
        ...
        public RedBlackNode(String element)
        {
            this( element, null, null );
        }

        //constructor to set value of element, leftChild, rightChild and color
        public RedBlackNode(String element, RedBlackNode leftChild, RedBlackNode rightChild)
        {
    ...
    class CreateRedBlackTree
    {
        ...
        private RedBlackNode great; //define great nod
        ...
        public CreateRedBlackTree(String header)
        {
        ...
        public void insertNewNode(String newElement )
        {
            ...
            while (!current.element.equalsIgnoreCase(newElement))//while current elemnt != new elemnt
            {
                great = grand;
                grand = parent;
                parent = current;
            ...
            if (parent.element.compareTo(newElement) > 0)
        ...
        private void handleColors(String newElement)
        {
            ...
            if (parent.color == RED)
            {
                ...
                if ( grand.element.compareTo(newElement) > 0 && !grand.element.equalsIgnoreCase(newElement) && parent.element.compareTo(newElement) > 0)
        ...
        private RedBlackNode performRotation(String newElement, RedBlackNode parent)
        {
            ...
            if(parent.element.compareTo(newElement) > 0) {
                ...
                if (parent.leftChild.element.compareTo(newElement) > 0) {
                ...
                if (parent.rightChild.element.compareTo(newElement) > 0) {
        ...
        private boolean searchNode(RedBlackNode node, String value)
        {
            boolean check = false;
            while ((node != nullNode) && !check)
            {
                String nodeValue = node.element;
    ...
    class RedBlackTreeExample
    {
        ...
        public static void main(String[] args)
        {
            ...
            CreateRedBlackTree obj = new CreateRedBlackTree("");
            char choice;
            ...
            do
            {
                ...
                switch (ch)
                {
                    case 1 :
                        ...
                        try {
                            File myObj = new File("C:\\Users\\alyab\\Downloads\\EN-US-Dictionary.txt");
                            Scanner myReader = new Scanner(myObj);
                            while (myReader.hasNextLine()) {
                                String data = myReader.nextLine();
                                obj.insertNewNode(data);
                                x++;
                            }
                    ...
                    case 2 :
                        ...
                        System.out.println(obj.searchNode(scan.next()));
                        break;
                    case 3 :
